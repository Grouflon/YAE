...
inline CORE_API void* alignForward(void* _p, u8 _align)
{
...
class CORE_API FixedSizeAllocator : public Allocator
{
public:
...
class CORE_API MallocAllocator : public Allocator
{
public:
	MallocAllocator();
...
CORE_API MallocAllocator& mallocAllocator();
