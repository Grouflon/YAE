...
EDITOR_API void initApplication(yae::Application* _application, const char** _args, int _argCount);
EDITOR_API void updateApplication(yae::Application* _application, float _dt);
EDITOR_API void shutdownApplication(yae::Application* _application);
